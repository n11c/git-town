...
cuke-go: build   # runs the new Godog-based feature tests
	godog --concurrency=$(shell nproc --all) --format=progress features/git-town features/git-town-alias features/git-town-append features/git-town-config/already_set.feature features/git-town-config/prompt.feature
